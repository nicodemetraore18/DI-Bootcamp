...
// indexOf("Foo") return -1 because "foo" does not exist in the array
//7
...
//Exercise2
   ...
   let colors=['white','lightblue', 'yellow','red' ,'black'];
   let suffixes=['st','nd','rd','th','th'];
   for(var i in colors ){
			function num() {
			 return ( colors.indexOf(colors[i])+1);
			  }
			console.log("My #"+ num()+suffixes[i]+" choice is " + colors[i])
		}
